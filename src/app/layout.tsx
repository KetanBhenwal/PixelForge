            ...
            <ul className="flex justify-center gap-8">
              <li>
                <Link href="/" className="hover:underline flex items-center gap-2">
                  <Image src="public/home.svg" alt="Home" width={20} height={20} />
                  Home
                </Link>
              </li>
              <li>
                <Link href="/convert-documents" className="hover:underline flex items-center gap-2">
                  <Image src="public/document.svg" alt="Convert Documents" width={20} height={20} />
                  Convert Documents
                </Link>
              </li>
              <li>
                <Link href="/compress-files" className="hover:underline flex items-center gap-2">
                  <Image src="public/compress.svg" alt="Compress Files" width={20} height={20} />
                  Compress Files
                </Link>
              </li>
              <li>
                <Link href="/file-management" className="hover:underline flex items-center gap-2">
                  <Image src="public/manage.svg" alt="File Management" width={20} height={20} />
                  File Management
                </Link>
              </li>
            </ul>
